...
class Element<T : Any>(
    ...
    operator fun get(key: String): Element<*> {
        ...
        throw IllegalArgumentException("Unable to get the field(\"$key\").")
    }
    ...
    fun asDouble(): Double {
        return when (element) {
            ...
            else -> throw IllegalArgumentException("Unable to parse to Double. Type: \"${element::class.java.simpleName}\" Value:\"$element\".")
        }
    }
    ...
    fun asLong(): Long {
        return when (element) {
            ...
            else -> throw IllegalArgumentException("Unable to parse to Long. Type: \"${element::class.java.simpleName}\" Value:\"$element\".")
        }
    }
    ...
    fun count() : Element<Int> {
        return when (element) {
            ...
            else -> throw IllegalArgumentException("Unable to count on this type. Type: \"${element::class.java.simpleName}\" Value:\"$element\".")
        }.let { Element(it) }
    }
